            ...
            <div id="house-details" class="container pt-5" v-if="houseDetails">
                ...
                <div class="row gx-5 mb-3">
                    ...
                    <div class="col-12 col-md-12 col-xl-5 mt-5 mt-lg-0">
                        <div class="card p-4">
                            <h3 class="custom-margin mb-2">Here what we can offer:</h3>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <p class="custom-divider mb-2">Bedroom:</p>
                                ...
                                <div class="col">
                                    <p class="custom-divider mb-2">Bathroom:</p>
                                    <div class="house-details-part d-flex">
                                ...
                                <div class="col">
                                    <p class="custom-divider mb-2">Kitchen:</p>
                                    <div class="house-details-part d-flex">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <p class="custom-divider mb-2">Fridge:</p>
                                    <div class="house-details-part d-flex">
                                        ...
                                        <div class="house-details">
                                            <i v-if="houseDetails.specs.fridge" class="fa-solid fa-check"></i>
                                            <i v-else class="fa-solid fa-xmark"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <p class="custom-divider mb-2">Kettle:</p>
                                    <div class="house-details-part d-flex">
                                        ...
                                        <div class="house-details">
                                            <i v-if="houseDetails.specs.kettle" class="fa-solid fa-check"></i>
                                            <i v-else class="fa-solid fa-xmark"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <p class="custom-divider mb-2">Iron:</p>
                                    <div class="house-details-part d-flex">
                                        <svg class="icon" style="width:24px;height:24px" data-name="Layer 1" id="Layer_1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="house-details">
                                            <i v-if="houseDetails.specs.iron" class="fa-solid fa-check"></i>
                                            <i v-else class="fa-solid fa-xmark"></i>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <p class="custom-divider mb-2">Pax:</p>
                                    <div class="house-details-part d-flex align-items-center">
                                        ...
                                        <div class="house-details">
                                            Suitable for {{ houseDetails.pax }} person
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <p class="custom-divider mb-2">Price:</p>
                                    <div class="house-details-part d-flex align-items-center">
                                        <svg class="icon" style="width:24px;height:24px" viewBox="0 0 24 24">
                                            <path fill="currentColor" d="M3,6H21V18H3V6M12,9A3,3 0 0,1 15,12A3,3 0 0,1 12,15A3,3 0 0,1 9,12A3,3 0 0,1 12,9M7,8A2,2 0 0,1 5,10V14A2,2 0 0,1 7,16H17A2,2 0 0,1 19,14V10A2,2 0 0,1 17,8H7Z" />
                                        </svg>
                                        <div class="house-details">
                                            Start from RM {{houseDetails.pricing}} per night
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col d-flex flex-column">
                            ...
                            <vue-timepicker
                                ...
                                format="HH:mm"
                                :minute-interval="30"
                                :hour-range="allowedHourRangeCheckIn"
                                :minute-range="allowedMinuteRangeCheckIn"
                                close-on-complete
                            >
                            </vue-timepicker>
                        </div>
...
onMounted(async () => {
    ...
    markers = [
        {
            position: houseDetails.value.coordinate,
        }
    ]

    console.log(houseDetails.value.booked_dates)
});
...
watch(selectedDate, (date) => {
    ...
    //updateAllowedTimeRanges(date)
    //console.log(new Date(date[0]).toISOString().split('T')[0])
})

const updateAllowedTimeRanges = (date) => { 
    const selectedDateWithoutTime = new Date(date[0]).toISOString().split('T')[0];
    const associatedBookedTime = houseDetails.value.booked_dates.find((fromBookedDate) => {
        const fromBookedDateWithoutTime = new Date(fromBookedDate).toISOString().split('T')[0];

        if (fromBookedDateWithoutTime == selectedDateWithoutTime) {
            console.log("true")
        }
    })
}
